...
struct UserModel: Identifiable {
    ...
    static func getUsers() -> [UserModel] {
        return [
            ...
            .init(username: "someone", profilePicture: "person-8", city: "Roma, Italy", isVerified: true),
            .init(username: "jordy.dev", profilePicture: "victorroldan.dev", city: "Lima, Peru", isVerified: true)
        ]
    }
}
